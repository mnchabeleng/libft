...
#    Updated: 2019/06/04 16:15:05 by mnchabel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_memchr.c \
	...
	ft_memalloc.c ft_memdel.c ft_strnew.c ft_strequ.c ft_strnequ.c \
	ft_strjoin.c ft_putchar.c ft_putstr.c ft_putendl.c ft_putchar_fd.c \
...
OBJ = ft_atoi.o ft_isalnum.o ft_isascii.o ft_isprint.o ft_memchr.o \
	...
	ft_memalloc.o ft_memdel.o ft_strnew.o ft_strequ.o ft_strnequ.o \
	ft_strjoin.o ft_putchar.o ft_putstr.o ft_putendl.o ft_putchar_fd.o \
