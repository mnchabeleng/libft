...
#    Updated: 2019/06/03 17:11:36 by mnchabel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_memchr.c \
	...
	ft_memalloc.c ft_strjoin.c ft_putchar.c ft_putstr.c ft_putchar_fd.c
...
OUT = ft_atoi.o ft_isalnum.o ft_isascii.o ft_isprint.o ft_memchr.o \
	...
	ft_memalloc.o ft_strjoin.o ft_putchar.o ft_putstr.o ft_putchar_fd.o
