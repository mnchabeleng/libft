...
#    Updated: 2019/06/06 14:42:45 by mnchabel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_memchr.c \
	...
	ft_strequ.c ft_strnequ.c ft_strjoin.c ft_putchar.c ft_putstr.c \
...
OBJ = ft_atoi.o ft_isalnum.o ft_isascii.o ft_isprint.o ft_memchr.o \
	...
	ft_strequ.o ft_strnequ.o ft_strjoin.o ft_putchar.o ft_putstr.o \
